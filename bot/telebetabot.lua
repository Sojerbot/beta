...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {161129693,116251654},--Sudo users
    disabled_channels = {},
    moderation = {data = 'data/moderation.json'},
    about_text = [[telebeta  V1
    ...
    Special Thanks To:
    mamad & •○مستـ↯ـر ♡ ممـ↯ـد○•
    
    Powered By @Telebeta
    
    #Open Source
    https://github.com/TELEBETA/beta
]],
    help_text_realm = [[
See Patterns In Github
]],
    help_fa_text = [[🚀دستورات فارسی ربات:
══════════════════════════════
🔰1- اداره اعضا
